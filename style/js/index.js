(function(){
	...
	*photo&video start
	**/
	var naviconbg1 ="url('template/ubike_qipai/style/img/photo-icon-normal.png')";
	var naviconbg2 ="url('template/ubike_qipai/style/img/photo-icon-hover.png')";

	jQuery('.wallpaper').eq(0).show()
	jQuery('.photo-video-nav ul li').eq(0).find('span').css('background-image',naviconbg2);
	jQuery('.photo-video-nav ul li').eq(0).css({backgroundImage:"url('template/ubike_qipai/style/img/photo-nav-hover.jpg')",color:'#000'});
	jQuery('.photo-video-nav ul li').click(function(){
		...
		jQuery(this).css({backgroundImage:"url('template/ubike_qipai/style/img/photo-nav-hover.jpg')",color:'#000'})
